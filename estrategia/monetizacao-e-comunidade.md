# Caminhos de monetização e comunidade
...
Nada pode ser vendido ou apresentado como terapia, atendimento, acompanhamento psicológico ou "grupo terapêutico", nem usar o título de psicóloga. Os produtos são de **leitura, escrita, reflexão e conversa**. Depois da formatura, as regras de publicidade do CFP passam a valer para qualquer divulgação de atendimento.

## Caminhos

| # | Caminho | Quando dá para começar | Esforço | Potencial |
|---|---|---|---|---|
...
| 8 | Encontros presenciais (piquenique literário, café com leitura) e, mais tarde, retiro para mães | com comunidade local ativa | alto | médio/alto |
| 9 | Oficinas de leitura e escrita (escolas, empresas, datas como Dia das Mães) | ~5 mil+ ou com a rede local | médio | médio |
| 10 | Livro próprio de crônicas (como a Roberta Ferec) | longo prazo, com os textos do Substack | alto | alto em autoridade |
| 11 | Depois de formada: atendimento clínico, com o público já construído | pós-formatura | — | alto |

## Escada sugerida

1. **Agora (0–3 meses)**: afiliados + Substack gratuito como lista própria + **1 leitura guiada paga** (valor de teste: R$ 29–49) para validar.
2. **3–6 meses**: produto digital (diário/guia) + 2ª e 3ª leituras guiadas + lista de espera do clube.
3. **6–12 meses**: lançamento do **clube por assinatura** para quem já participou + Substack pago.
4. **Longo prazo**: livro, eventos, oficinas, parcerias pagas.
...
- **Chat do Substack** como espaço de conversa fora do algoritmo.
